...
public class DnDCharacterSheet
{
    public static void main(String args[]) {
        ...
        if (Bio.CharacterClass.equals("Barbarian")){
            Bio.setCharacterClass("Barbarian");
        } if (Bio.CharacterClass.equals("Fighter")){
            Bio.setCharacterClass("Fighter");
        } if (Bio.CharacterClass.equals("Paladin")){
            Bio.setCharacterClass("Paladin");
        } if (Bio.CharacterClass.equals("Cleric")){
            Bio.setCharacterClass("Cleric");
        } if (Bio.CharacterClass.equals("Druid")){
            Bio.setCharacterClass("Druid");
        } if (Bio.CharacterClass.equals("Monk")){
            Bio.setCharacterClass("Monk");
        } if (Bio.CharacterClass.equals("Warlock")){
            Bio.setCharacterClass("Warlock");
        } if (Bio.CharacterClass.equals("Ranger")){
            Bio.setCharacterClass("Ranger");
        } if (Bio.CharacterClass.equals("Rogue")){
            Bio.setCharacterClass("Rogue");
        } if (Bio.CharacterClass.equals("Bard")){
            Bio.setCharacterClass("Bard");
        } if (Bio.CharacterClass.equals("Wizard")){
            Bio.setCharacterClass("Wizard");
        } if (Bio.CharacterClass.equals("Mage")){
            Bio.setCharacterClass("Mage");
        } if (Bio.CharacterClass.equals("Sorcerer")){
            Bio.setCharacterClass("Sorcerer");
        }
        ...
        thecpoints.setuphitpoints(Stats);
