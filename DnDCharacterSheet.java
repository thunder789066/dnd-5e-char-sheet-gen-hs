...
public class DnDCharacterSheet
{
    public static void main(String args[]) {
        ...
        Scanner carmor = new Scanner(System.in);            // choosing armor
        try {
            System.out.print("# Selection: ");
            int armornum = carmor.nextInt();
            defendchar.ArmorSet = defenseStats.ListOfArmor[armornum-1];
        }
        catch(InputMismatchException exception) {
            System.out.println("Invalid. Please select a different choice."); 
        }
        ...
        System.out.println("Armor Class: " + defendchar.ArmorClass + "\t\tInitiative: " + thecpoints.Initiative + "\t\tMax Hit Points: " + thecpoints.HitPoints + "\t\tSpeed: " + thecpoints.Speed + newline);
